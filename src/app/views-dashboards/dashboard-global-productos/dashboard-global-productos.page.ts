...
import { CreateCarritoPage } from '../../views-carritos/create-carrito/create-carrito.page';


@Component({
  selector: 'app-dashboard-global-productos',
  templateUrl: './dashboard-global-productos.page.html',
  styleUrls: ['./dashboard-global-productos.page.scss', '../../app.component.scss'],
})
export class DashboardGlobalProductosPage implements OnInit {
