...
@Component({
  ...
  templateUrl: './crear-carrito.page.html',
  styleUrls: ['./crear-carrito.page.scss', '../app.component.scss'],
})
export class CrearCarritoPage implements OnInit {
